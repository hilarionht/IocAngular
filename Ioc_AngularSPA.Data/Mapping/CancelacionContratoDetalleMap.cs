...
{
    public class CancelacionContratoDetalleMap : EntityTypeConfiguration<CancelacionContratoDetalle>
    {
        public CancelacionContratoDetalleMap()
        {
            HasKey(t => t.ID);
            //properties             
            ...
            ToTable("FID_CancelacionContratoDetalle");
        }
    }
}

...
{
    public class CancelacionImpresionMap: EntityTypeConfiguration<CancelacionImpresion>
    {
        public CancelacionImpresionMap()
        {
            //key
            HasKey(t => t.ID);
            //properties
            ...
            //table  
            ToTable(tableName: "FID_CancelacionImpresion");
        }
    }
}

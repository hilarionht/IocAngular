...
{
    public class CancelacionContratoImpresionMap : EntityTypeConfiguration<CancelacionContratoImpresion>
    {
        public CancelacionContratoImpresionMap()
        {
            //key
            HasKey(t => t.ID);
            //properties
            ...
            //table  
            ToTable(tableName: "FID_CancelacionContratoImpresion");
        }
    }
}

...
{
    public class DevolucionRecursoArchivoMap : EntityTypeConfiguration<DevolucionRecursoArchivo>
    {
        public DevolucionRecursoArchivoMap()
        {
            //key
            HasKey(t => t.ID);
            //properties
            ...
            //table  
            ToTable("FID_DevolucionRecursoArchivo");

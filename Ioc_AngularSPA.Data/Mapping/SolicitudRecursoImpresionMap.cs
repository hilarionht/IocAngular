...
{
    public class SolicitudRecursoImpresionMap : EntityTypeConfiguration<SolicitudRecursoImpresion>
    {
        public SolicitudRecursoImpresionMap()
        {
            //key
            HasKey(t => t.ID);
            //properties
            ...
            //table  
            ToTable(tableName: "FID_SolicitudRecursoImpresion");
        }
    }
}

...
{
    public class SolicitudRecursoArchivoMap : EntityTypeConfiguration<SolicitudRecursoArchivo>
    {
        public SolicitudRecursoArchivoMap()
        {
            //key
            HasKey(t => t.ID);
            //properties
            ...
            //table  
            ToTable("FID_SolicitudRecursoArchivo");

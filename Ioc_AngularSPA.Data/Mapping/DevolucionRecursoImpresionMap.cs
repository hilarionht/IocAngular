...
{
    public class DevolucionRecursoImpresionMap : EntityTypeConfiguration<DevolucionRecursoImpresion>
    {
        public DevolucionRecursoImpresionMap()
        {
            //key
            HasKey(t => t.ID);
            //properties
            ...
            //table  
            ToTable(tableName: "FID_DevolucionRecursoImpresion");
        }
    }
}
